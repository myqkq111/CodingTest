...
//		int res = 0;
//		
//		for(int i = 2; i <= n; i+=2) { //n이하의 짝수를 더하는 문제이기 때문에 2부터 시작해서 2씩 증가시켜준다.
//			res += i;
//		}
//		return res;
//	}
...
//		
//		k = (k - (n / 10)) * 2000; //총 음료수 가격(양꼬치 10인분당 음료수 1개 서비스를 제외한 나머지 음료수 값)  
//		n *= 12000; //총 양꼬치 가격
//		
//		return n + k;
//	}
...
//		
//		int su = money / 5500; //잔 수 
//		int change = money % 5500; //잔 돈
//		
//		int[] res = {su, change};
//		
//		return res;

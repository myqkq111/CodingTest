...
//		61. 직사각형 형태의 그림 파일이 있고, 이 그림 파일은 1 × 1 크기의 정사각형 크기의 픽셀로 이루어져 있습니다. 
...
//		int k = 3;
//		
//		String[] res = lm.solution(picture, k);
//		
...
//		62. n × n 크기의 이차원 배열 arr이 매개변수로 주어질 때, arr이 다음을 만족하면 1을 아니라면 0을 return 하는 solution 함수를 작성해 주세요.
//
...
//		int[][] arr = {{1,2},{3,4}};
//		
//		System.out.println(Arrays.deepToString(lm.solution(arr)));
...
//		64. 2차원 정수 배열 board와 정수 k가 주어집니다.
//
...
//		int k = 2;
//		
//		System.out.println(lm.solution(board, k));
